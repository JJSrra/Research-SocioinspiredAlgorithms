...
def Fickleness(current_fitness, best_fitness, best_past_fitness, fickleness_rate):
    return 1 - fickleness_rate*(best_fitness/current_fitness) - (1-fickleness_rate)*(best_past_fitness/current_fitness)
